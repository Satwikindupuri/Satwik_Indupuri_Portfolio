...
const Projects = () => {
  const projects = [
    ...
    {
      title: "EduShelf",
      description: "EduShelf is a serverless book exchange platform designed to bridge the gap between seniors, juniors, and students.",
      technologies: ["React", "TypeScript", "Tailwind CSS", "GitHub for version control", "Firebase for authentication and database"],
      features: [
    ...
    github: "https://github.com/Satwikindupuri/EduShelf.git",
    demo: "https://edushelf-iitk.vercel.app/",
    status: "Completed"
}
  ];
